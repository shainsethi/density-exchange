  ...
  return (
    <div className='py-10 container mx-auto w-11/12 '>
          ...
          <div className='flex justify-between items-center py-8 gap-10'>
             <div><img className='inline pr-2' height={40} width={40} src='https://img.icons8.com/color/48/marker--v1.png'/>AugustraBe 26, 100117 India</div>
             <div><img className='inline pr-2' height={40} width={40} src='https://img.icons8.com/fluency/48/mail--v1.png'/>hi@ahead-app.com</div>
          </div>
